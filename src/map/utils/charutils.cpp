...
namespace charutils
{
    ...
    ************************************************************************/
    ...
    {
        memset(PChar->m_SpellList, 0, sizeof(PChar->m_SpellList));
        ...
        size_t length = sizeof(PChar->m_SpellList);
        // Copy learned spells on to enabled spells
        memcpy(PChar->m_EnabledSpellList, PChar->m_SpellList, (length > sizeof(PChar->m_EnabledSpellList) ? sizeof(PChar->m_EnabledSpellList) : length));

        // Remove prohibited spells
